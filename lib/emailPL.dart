...
class EmailVerificationPL extends StatefulWidget {
  const EmailVerificationPL({super.key});

  @override
  State<EmailVerificationPL> createState() => _EmailVerificationPLState();
}

String cardSel = 'agent';

class _EmailVerificationPLState extends State<EmailVerificationPL> {
  ...
  void loginUser() async {
    ...
    if (res == "success") {
      Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (context) => const ESAFMobile()));
    } else {
  ...
  void navigateToSignUp() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => const CreateUserPL(),
      ),
    );
  }
